...
export function saveSourceCatalog(
  state: SourceCatalogState = getSourceCatalogState(),
): void {
  setSourceCatalogState(state);
  saveStoredJson(CUSTOM_RASTER_SOURCES_STORAGE_KEY, getSourceCatalogState());
}
